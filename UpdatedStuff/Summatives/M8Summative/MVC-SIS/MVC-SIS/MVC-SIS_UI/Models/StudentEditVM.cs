...
namespace MVC_SIS_UI.Models
{
    public class StudentEditVM : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                errors.Add(new ValidationResult("Please select a GPA between 0 and 4.",
                    new[] { "Student.GPA" }));
            }
            if (Student.Address == null || Student.Address.Street1 == "" || Student.Address.Street1 == null)
            {
                errors.Add(new ValidationResult("Please enter a Street Address",
                    new[] { "Student.Address.Street1" }));
            }
            if (Student.Address == null || Student.Address.City == "" || Student.Address.City == null)
            {
                errors.Add(new ValidationResult("Please enter a City Name",
                    new[] { "Student.Address.City" }));
            }
            if (Student.Address == null || Student.Address.PostalCode == "" || Student.Address.PostalCode == null)
            {
                errors.Add(new ValidationResult("Please enter a Zip Code",
