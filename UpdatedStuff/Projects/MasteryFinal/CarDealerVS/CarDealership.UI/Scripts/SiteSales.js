$(document).ready(function () {
            ...
            function search() {
                ...
                var detailsPath = 'http://localhost:44396/Sales/PurchaseVehicle/';
                ...
                $.ajax({
                    type: 'GET',
                    url: 'http://localhost:44396/api/Sales/Index?' + params,
                    async: false,
                    cache: false,
                    success: function (results) {
                        ...
                        $.each(results, function (index, vehicle) {
                            var html =
                                ...
                                '<div class="col-md-3"><p><strong>Sale Price: </strong>' + vehicle.SalePrice + '</p>' + '<p><strong>MSRP: </strong>' + vehicle.MSRP + '</p>' + '<a href="' + detailsPath + vehicle.VehicleID + '"><button class="btn btn-primary">Purchase</button></a></div>' +
                                '</div>';
